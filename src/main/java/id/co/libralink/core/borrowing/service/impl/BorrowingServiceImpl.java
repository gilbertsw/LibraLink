package id.co.libralink.core.borrowing.service.impl;
...
import id.co.libralink.core.borrowing.mapper.BorrowingDetailMapper;
import id.co.libralink.core.borrowing.mapper.BorrowingListMapper;
...
import id.co.libralink.core.borrowing.query.BorrowingQuery;
import id.co.libralink.core.borrowing.repository.BorrowingRepository;
...
public class BorrowingServiceImpl implements BorrowingService {
    ...
    @Override
    public Integer countByStatus(Set<BorrowStatus> statuses) {
        if (statuses == null || statuses.isEmpty()) {
            statuses = EnumSet.allOf(BorrowStatus.class);
        }
        return borrowingRepository.countByStatusIn(statuses);
    }
