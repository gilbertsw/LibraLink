package id.co.libralink.core.book.service.impl;

import id.co.libralink.core.book.enums.BookStatus;
import id.co.libralink.core.book.mapper.BookDetailMapper;
import id.co.libralink.core.book.mapper.BookListMapper;
import id.co.libralink.core.book.mapper.BookRequestMapper;
...
import id.co.libralink.core.book.query.BookQuery;
import id.co.libralink.core.book.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Integer countByStatus(Set<BookStatus> statuses) {
        if (statuses == null || statuses.isEmpty()) {
            statuses = EnumSet.allOf(BookStatus.class);
        }
        return bookRepository.countBookByStatusIn(statuses);
    }
